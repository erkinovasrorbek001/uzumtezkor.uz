...
function Section() {
  ...
  return (
    <div id='ishlash' className='Section py-10'>
        <div className='Section__container dark:bg-[#1a1a2e]  py-20 bg-[#fff] duration-1000'>
            <nav className='Section__nav max-w-[1200px] mx-auto '>
                ...
                <ul className='Section__lsit grid grid-cols-1 gap-10  mt-10 ml-5 mr-5'>
                    <li data-aos='zoom-in-right' className='Section__item max-w-[1060px] w-full  py-10 px-5  dark:bg-[#7000FF] text-black  dark:text-white  bg-[#F3F3F4]  mx-auto  justify-between items-center rounded-[40px]  flex'>
                        ...
                        <button className='Section__button  mt-15 dark:border-1  border-1 border-white dark:border-white  px-10 py-7 rounded-[30px] font-bold text-2xl'><Link to="/Contact"> {t("Anketani to'ldiring")} </Link></button>
                        </div>
                        <div className='Section__right'>
                            <img className='w-[300px] max-[1055px]:hidden scale-133 -mt-11 mr-8' src={img} alt="" />
                        </div>
                    </li>
                    <li data-aos='zoom-in' className='Section__item max-w-[1060px]  py-10 px-5 dark:bg-[#7000FF] text-black  dark:text-white  bg-[#F3F3F4]  mx-auto  justify-between items-center rounded-[40px]  '>
                    ...
                    <li data-aos='zoom-in-right' className='Section__item max-w-[1060px]  py-10 px-5 w-full dark:bg-[#7000FF] text-black  dark:text-white  bg-[#F3F3F4]  mx-auto  justify-between items-center rounded-[40px] '>
                    ...
                    <li data-aos='zoom-in' className='Section__item max-w-[1060px]   py-10 px-5 dark:bg-[#F3F3F4]   dark:text-black  bg-[#7000FF]  mx-auto  justify-between items-center rounded-[40px]  flex'>
                        <div className='Section__left dark:text-[#7000FF] text-white duration-1000'>
                        ...
                        <button className='Section_button mt-9 px-10 py-7 rounded-[30px] font-bold text-2xl'><Link to="/Contact"> {t("Ishlashni boshlash")}</Link></button>
                        </div>
                        <div className='Section__right'>
