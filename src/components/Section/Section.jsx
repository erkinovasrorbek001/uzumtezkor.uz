...
function Section() {
  ...
  return (
    <div id='ishlash' className='Section py-10'>
        <div className='Section__container dark:bg-[#12121f]  py-20 bg-[#fff] duration-1000'>
            <nav className='Section__nav max-w-[1200px] mx-auto '>
                ...
                <ul className='Section__lsit grid grid-cols-1 gap-10  mt-10 ml-5 mr-5'>
                    <li data-aos='zoom-in-right' className='Section__item max-w-[1060px] w-full  py-10 px-5  dark:bg-[#12121f] border-1 shadow-md text-black  dark:text-white  bg-[#fff]  mx-auto  justify-between items-center rounded-[40px]  flex'>
